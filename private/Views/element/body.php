	...
	<body>
        <div class="row">
          <div class="col-md-3">
          <h1>Migrants en France: de la difficulté d’être en règle</h1>
		  <img src="\private\Views\element\images\image1.jpg" alt="Photo de montagne" />
		  <p>De la demande de visa à l’obtention d’un titre de séjour en passant par la demande du droit d’asile, les étrangers venant en France doivent faire face à de nombreuses difficultés. Alors que l’extrême droite estime que la France accueille trop d’étrangers, les démarches difficiles et les chiffres prouvent pourtant que le pays n’est pas laxiste en la matière. Un point sur les chiffres et les démarches.
...
Des exigences à géométrie variable qui rendent difficile l’accompagnement des migrants : « Les exigences varient d’une préfecture à une autre, d’un agent préfectoral à un autre, regrette Lisa Faron. Vous pouvez accompagner un jour en tant que militant de la Cimade une personne étrangère pour une demande, cela se passe bien, et puis la semaine d’après vous accompagnez une personne qui vous semble être dans la même situation, ça se passe mal et vous ne savez pas pourquoi. On est dans un arbitraire très fort et dans un pouvoir très fort de la préfecture ». Des difficultés que confirme une avocate régulièrement confrontée aux problèmes des sans-papiers. Celle-ci porte un regard très critique sur les démarches administratives souvent contradictoires avec la réalité du quotidien des personnes.
          ...
          <div class="col-md-3">
                    <h1>Repères sur la santé des migrants </h1>
		  <img src="\private\Views\element\images\image2.jpg" alt="Photo de montagne" />
		  <p>Immigrés, étrangers, réfugiés, sans-papiers ou encore " personnes d'origine étrangère ", l'usage parfois indifférencié de ces termes témoigne d'une certaine confusion dans l'ensemble de la société sur le statut des migrants en France (voir encadré ci-contre), cette confusion étant imputable pour partie à la politisation des questions d'immigration et d'asile au cours des trente dernières années. Dans la même période, l'émergence de nouvelles priorités de santé publique, en premier lieu la lutte contre l'épidémie de VIH-sida, a progressivement conduit les pouvoirs publics à prendre en compte les spécificités des populations migrantes en matière de santé (1). Si les données d'épidémiologie médicale restent rares, la contribution des sciences humaines et l'expertise des acteurs de terrain ont permis d'améliorer les connaissances sur les facteurs de vulnérabilité de ces populations et d'adapter ainsi les actions à mettre en œuvre pour la santé des migrants.</p>


          </div>
          <div class="col-md-3">
                              <h1>Tensions communautaires et difficultés pour les femmes d’être seules avec eux … </h1>
		  <img src="\private\Views\element\images\image3.jpg" alt="Photo de montagne" />
		  <p>20 migrants de Calais vont arriver dans les prochaines heures au CAO de Kerlaz (institut la Clarté) à proximité de Douarnenez. Au total entre 700 et 900 individus seront logés, nourris, blanchis dans des locaux en Bretagne (B5)
